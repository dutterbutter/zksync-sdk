...
const k256hex = (s: string) =>
  ('0x' + bytesToHex(keccak_256(utf8ToBytes(s)))).toLowerCase();

export const TOPIC_L1_MESSAGE_SENT_NEW = k256hex(
  'L1MessageSent(uint256,bytes32,bytes)',
);

export const TOPIC_L1_MESSAGE_SENT_LEG = k256hex(
