...
export const local_era: ChainInfo = {
  ...
  addresses: {
    l1: {
      bridgehub: '0x0000000000000000000000000000000000010001',
      assetRouter: '0x0000000000000000000000000000000000010002',
      nativeTokenVault: '0x0000000000000000000000000000000000010003',
    },
    l2: {
