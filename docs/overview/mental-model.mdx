...
<Hint>
Best for **custom workflows** (e.g., multisigs or when you want to review the raw tx data before signing).
</Hint>
...
<Hint>
Best for **polling in a UI** to show live progress without blocking.
</Hint>
...
<Hint>
Best for **claiming funds back to Ethereum** once the withdrawal is ready.
</Hint>
...
<Hint>
Best for **applications that want explicit, predictable error handling** and to avoid uncaught exceptions.
</Hint>
