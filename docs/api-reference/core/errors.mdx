...
<Tip>
Prefer the <code>try*</code> variants when you want to avoid exceptions and branch on success/failure.
</Tip>
...
<Warning>
Avoid parsing <code>err.message</code> for logic. Use the typed fields on <code>err.envelope</code> instead.
</Warning>
