...
```ts
import { createPublicClient, http, createWalletClient, privateKeyToAccount, parseEther } from 'viem';
...
- **Standard <code>eth_*</code> RPC** should be performed through your chosen base library (**ethers** / **viem**).  
